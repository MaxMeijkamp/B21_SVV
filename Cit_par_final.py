...
def ac_fin(m=6000) -> FlightParams:
    ...
    th0 = 0 * pi / 180  # pitch angle in the stationary flight condition [rad]
    gamma0 = th0 - alpha0
    ...
    e      = 0.7880025        # Oswald factor [ ]
    CD0    = 0.021953128      # Zero lift drag coefficient [ ]
    CLa    = 4.95257216       # Slope of CL-alpha curve [ ]

    # Longitudinal stability
    Cma    = -0.5          # longitudinal stabilty [ ]
    # Cmde   = -1.064          # elevator effectiveness [ ]
    Cmde   = -1.2
